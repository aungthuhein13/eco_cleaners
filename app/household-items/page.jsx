...
export const metadata = {
  title: "Household Item Cleaning in Trabuco Canyon | Eco Cleaners",
  description:
    "Household item cleaning in Trabuco Canyon. Comforters, blankets, bedspreads, linens, tablecloths, and more at Eco Cleaners.",
};
          ...
          <div className="mt-10 grid items-center gap-12 md:grid-cols-2">
            <div>
              ...
              <h1 className="max-w-xl text-5xl font-semibold leading-tight tracking-tight md:text-6xl">
                Fresh care for comforters, blankets, and home linens.
              </h1>

              <p className="mt-6 max-w-xl text-lg leading-8 text-[#4B6359]">
                Eco Cleaners helps clean household items such as comforters,
                blankets, bedspreads, tablecloths, linens, and more. Bring your
                items in and we’ll review the best cleaning option.
              </p>
            ...
            <div className="rounded-[2rem] border border-[#D7C9A3] bg-white p-3 shadow-lg">
              <div className="relative h-[420px] overflow-hidden rounded-[1.5rem] md:h-[520px]">
                <Image
                  src="/comforter.png"
                  alt="Household item cleaning at Eco Cleaners"
                  fill
                  priority
                ...
                <div className="absolute bottom-4 left-4 right-4 rounded-2xl bg-white/92 p-4 shadow-lg backdrop-blur sm:bottom-5 sm:left-5 sm:right-5 sm:p-5">
                  ...
                  <h2 className="mt-2 text-xl font-semibold text-[#173B2F] sm:text-2xl">
                    Bigger items deserve proper care.
                  </h2>

                  <p className="mt-2 text-xs leading-5 text-[#4B6359] sm:text-sm sm:leading-6">
                    Comforters, blankets, linens, tablecloths, and more.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="rounded-[2rem] border border-[#D7C9A3] bg-white p-8 shadow-sm md:p-10">
            <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">
              What is household item cleaning?
            </h2>

            <p className="mt-5 max-w-4xl text-lg leading-8 text-[#4B6359]">
              Household item cleaning is for larger home fabrics and linens that
              may be difficult to clean properly at home. Items like comforters,
              blankets, bedspreads, tablecloths, and linens may need different
              cleaning care depending on size, fabric, filling, stains, and
              condition.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-tight md:text-5xl">
              Cleaning for household fabrics and linens.
            </h2>

            <p className="mt-5 text-lg leading-8 text-[#4B6359]">
              Bring your household items in and we’ll review the fabric, size,
              condition, and cleaning needs before recommending the next step.
            </p>
          </div>
      ...
      <section className="px-6 py-12">
        <div className="mx-auto grid max-w-7xl gap-5 md:grid-cols-3">
          <div className="rounded-[1.5rem] border border-[#D7C9A3] bg-white p-6 shadow-sm">
            <h3 className="text-xl font-semibold">Large Item Care</h3>
            <p className="mt-3 leading-7 text-[#4B6359]">
              Comforters, blankets, and bedspreads can be bulky and difficult to
              clean well at home.
            </p>
          </div>
          ...
          <div className="rounded-[1.5rem] border border-[#D7C9A3] bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 leading-7 text-[#4B6359]">
              Cleaning options may depend on the fabric, filling, label
              instructions, stains, and overall condition.
            </p>
          </div>

          <div className="rounded-[1.5rem] border border-[#D7C9A3] bg-white p-6 shadow-sm">
            <h3 className="text-xl font-semibold">Fresh Home Essentials</h3>
            <p className="mt-3 leading-7 text-[#4B6359]">
              Great for seasonal cleaning, guest linens, bedding refreshes, and
          ...
          <div className="grid items-center gap-8 md:grid-cols-[1.3fr_0.7fr]">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-semibold md:text-5xl">
                Need household items cleaned?
              </h2>

              <p className="mt-4 max-w-2xl text-lg leading-8 text-white/80">
                Stop by with your comforters, blankets, linens, or household
                items for review. We’ll help you understand the best cleaning
                option.
              </p>
            </div>
