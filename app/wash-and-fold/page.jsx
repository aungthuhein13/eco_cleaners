...
export const metadata = {
  title: "Wash & Fold Laundry in Trabuco Canyon | Eco Cleaners",
  description:
    "Wash and fold laundry service in Trabuco Canyon. Drop off everyday laundry, towels, clothes, and family laundry at Eco Cleaners.",
};
          ...
          <div className="mt-3 grid items-center gap-12 md:grid-cols-2">
            <div>
              ...
              <h1 className="max-w-xl text-5xl font-semibold leading-tight tracking-tight md:text-6xl">
                Fresh laundry without the extra work.
              </h1>

              <p className="mt-6 max-w-xl text-lg leading-8 text-[#4B6359]">
                Eco Cleaners offers convenient wash and fold laundry service for
                everyday clothes, towels, and family laundry. Drop it off, and
                we’ll wash, dry, fold, and neatly prepare it for pickup.
              </p>
            ...
            <div className="rounded-[2rem] border border-[#D7C9A3] bg-white p-3 shadow-lg">
              <div className="relative h-[420px] overflow-hidden rounded-[1.5rem] md:h-[520px]">
                <Image
                  src="/wash-and-fold.png"
                  alt="Wash and fold laundry service at Eco Cleaners"
                  fill
                  priority
                ...
                <div className="absolute bottom-4 left-4 right-4 rounded-2xl bg-white/92 p-4 shadow-lg backdrop-blur sm:bottom-5 sm:left-5 sm:right-5 sm:p-5">
                  ...
                  <h2 className="mt-2 text-xl font-semibold text-[#173B2F] sm:text-2xl">
                    Washed, dried, folded, and ready.
                  </h2>

                  <p className="mt-2 text-xs leading-5 text-[#4B6359] sm:text-sm sm:leading-6">
                    A simple laundry solution for busy households and everyday
                    clothes.
                  </p>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="rounded-[2rem] border border-[#D7C9A3] bg-white p-8 shadow-sm md:p-10">
            ...
            <p className="mt-5 max-w-4xl text-lg leading-8 text-[#4B6359]">
              Wash and fold is a laundry service where everyday clothes are
              washed, dried, folded, and packaged for pickup. It is a convenient
              option for regular laundry such as shirts, pants, towels,
              pajamas, workout clothes, and family laundry that does not need
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-lg leading-8 text-[#4B6359]">
              Whether you are catching up on weekly laundry or need help with a
              busy schedule, our wash and fold service keeps things simple.
            </p>
          </div>

          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {washFoldServices.map((service) => (
              <div
                key={service}
      ...
      <section className="px-6 py-12">
        <div className="mx-auto grid max-w-7xl gap-5 md:grid-cols-3">
          <div className="rounded-[1.5rem] border border-[#D7C9A3] bg-white p-6 shadow-sm">
            <h3 className="text-xl font-semibold">Simple Drop-Off</h3>
            <p className="mt-3 leading-7 text-[#4B6359]">
              Bring in your laundry, and we’ll help take care of the washing,
              drying, folding, and packaging.
            </p>
          </div>

          <div className="rounded-[1.5rem] border border-[#D7C9A3] bg-white p-6 shadow-sm">
            <h3 className="text-xl font-semibold">Neatly Folded</h3>
            <p className="mt-3 leading-7 text-[#4B6359]">
              Laundry is folded and prepared so it is easier to take home, put
              away, and use.
            </p>
          </div>

          <div className="rounded-[1.5rem] border border-[#D7C9A3] bg-white p-6 shadow-sm">
            <h3 className="text-xl font-semibold">Great for Busy Schedules</h3>
            <p className="mt-3 leading-7 text-[#4B6359]">
              Wash and fold is a convenient option for families, professionals,
              students, and anyone short on time.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid items-center gap-8 md:grid-cols-[1.3fr_0.7fr]">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-lg leading-8 text-white/80">
                Stop by Eco Cleaners for convenient wash and fold laundry
                service in Trabuco Canyon.
              </p>
            </div>
